      ...
      <b-row>
        ...
        <b-col md="2">
          <b-form-group id="prinipleLbl" label="Priniple" label-for="priniple" style="color:red;">
            <b-form-input
              id="priniple"
              v-model="submitForm.bookingTrans.priniple"
              style="color:red;"
            ></b-form-input>
          </b-form-group>
        </b-col>
        <b-col md="2">
          <b-form-group id="intrestLbl" label="Intrest" label-for="intrest" style="color:red;">
            <b-form-input
              id="intrest"
              @blur="givenUpToDate"
              v-model="submitForm.bookingTrans.intrest"
              style="color:red;"
            ></b-form-input>
          </b-form-group>
        </b-col>
        ...
        <b-col>
          <b-form-group id="descriptionLbl" label="Description" label-for="description">
            <b-form-input id="description" v-model="submitForm.bookingTrans.description"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
    </b-card>
              ...
              <b-tbody>
                ...
                <b-tr>
                  ...
                  <b-td colspan="4" style="border-top:0px">
                    <b-form-input id="intrestPaidTil" v-model="submitForm.bookingTrans.remarks"></b-form-input>
                  </b-td>
                </b-tr>
              </b-tbody>
            </b-table-simple>
  ...
  methods: {
    givenUpToDate() {
      ...
      if (this.lastTrans != null) {
        daysDiff =
          (parseFloat(this.submitForm.bookingTrans.intrest) +
        ...
        daysDiff = parseFloat(this.submitForm.bookingTrans.intrest) / perDay;
